...
{
    [Theory]
    [InlineData("Server=localhost;Database=G2ERP_DEV_LOCAL_TEST;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True")]
    ...
    [Fact]
    public void ValidateLocalOnly_RejectsUnencryptedConnectionWithoutExplicitDevelopmentOptIn() =>
        Assert.Throws<InvalidOperationException>(() => SqlServerConnectionFactory.ValidateLocalOnly("Server=localhost;Database=G2ERP_DEV_LOCAL_TEST;Trusted_Connection=True;Encrypt=False", true, false, "G2ERP_DEV_LOCAL", "G2ERP_DEV_LOCAL_TEST"));
}
