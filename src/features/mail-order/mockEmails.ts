...
export const mockEmails: readonly MailMessage[] = [
  {
    ...
    FROM_ADDRESS: "order@semyung.example.com",
    FROM_NAME: "세명테크 수주팀",
    SUBJECT: "[수주] 산업용 컨트롤러 7월 발주",
    RECEIVED_AT: "2026-07-10 09:14",
    BODY_TEXT: `안녕하세요. 수주를 요청드립니다.\n거래처명: 세명테크\n거래처코드: P-10021\n수주일자: 2026/07/10\n비고: 정기 수주\n품목: ITM-1001 | 산업용 컨트롤러 A | 수량: 3 | 단가: 120,000 | 납기: 2026-07-22 | 비고: 우선 납품`,
    ATTACHMENTS: [],
    PARSE_STATUS: "대기",
    ERROR_MESSAGE: null
  },
  {
    ...
    FROM_ADDRESS: "po@hanbit.example.com",
    FROM_NAME: "한빛산업 구매팀",
    SUBJECT: "[수주] 생산 품목 2종 발주",
    ...
    ATTACHMENTS: [{ FILE_NAME: "purchase-order.txt", MIME_TYPE: "text/plain", SIZE: 248, MOCK_CONTENT: "reference content" }],
    PARSE_STATUS: "대기",
    ERROR_MESSAGE: null
  },
  {
    MAIL_ID: "mock-mail-partner-missing-003",
    FROM_ADDRESS: "purchase@unknown.example.com",
    FROM_NAME: "가상 거래처 담당자",
    SUBJECT: "[수주] 거래처 코드 확인 요청",
  ...
  },
  {
    ...
    FROM_ADDRESS: "order@mirae.example.com",
    FROM_NAME: "미래정밀 수주팀",
    SUBJECT: "[수주] 품목코드 일부 확인 요청",
    RECEIVED_AT: "2026-07-10 13:30",
    BODY_TEXT: `거래처명: 미래정밀\n거래처코드: P-10058\n수주일자: 2026-07-10\n품목: ITM-1308 | 서보 드라이브 2kW | 수량: 1 | 단가: 500,000 | 납기: 2026-07-26 | 비고: 정상\n품목:  | 미등록 품목 | 수량: 2 | 단가: 10,000 | 납기: 2026-07-26 | 비고: 코드 확인 필요`,
    ATTACHMENTS: [],
    PARSE_STATUS: "대기",
    ERROR_MESSAGE: null
  },
  {
    ...
    FROM_ADDRESS: "order@cheongsol.example.com",
    FROM_NAME: "청솔전자 구매팀",
    SUBJECT: "[수주] 수량 형식 확인 요청",
  ...
  },
  {
    ...
    FROM_ADDRESS: "notice@operations.example.com",
    FROM_NAME: "운영 공지",
    SUBJECT: "[공지] 시스템 점검 안내",
    RECEIVED_AT: "2026-07-10 16:20",
    BODY_TEXT: "이번 주말 시스템 점검이 예정되어 있습니다. 수주 요청이나 품목 정보는 포함되어 있지 않습니다.",
    ATTACHMENTS: [],
    PARSE_STATUS: "대기",
    ERROR_MESSAGE: null
  }
